...
export default function AdminGuard({ children }: { children: React.ReactNode }) {
  ...
  if (!user || user.email !== 'jmatheusbuchmann@gmail.com') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <div className="max-w-md w-full bg-white p-12 rounded-[3.5rem] shadow-2xl border border-slate-100 text-center space-y-8">
           ...
           {user && user.email !== 'jmatheusbuchmann@gmail.com' && (
           ...
           <button 
             ...
             className="w-full py-5 bg-primary text-white rounded-2xl font-bold uppercase tracking-widest shadow-xl shadow-primary/20 flex items-center justify-center gap-3 hover:scale-105 active:scale-95 transition-all"
           >
